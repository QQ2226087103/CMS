                ...
                <div id="sidebar-menu"
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> 开发者账户管理 <span
                                    class="fa fa-chevron-down"></span>
                            </a>
                                <ul class="nav child_menu">
                                    <li><a href="javascript:">开发者账户申请</a>
                                    </li>
                                    <li><a href="javascript:">个人账户信息维护</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> 手游应用管理<span
                                    class="fa fa-chevron-down"></span>
                            </a>
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath }/app/list">手游应用维护</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
